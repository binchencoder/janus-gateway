...
const (
	ApiSourceType_EASE_GATEWAY ApiSourceType = 0 // ease-gateway apis.
	ApiSourceType_OPEN_GATEWAY ApiSourceType = 1 // open-gateway open apis.
)
...
const (
	AuthTokenType_EASE_AUTH_TOKEN   AuthTokenType = 0 // ease gateway auth type.
	AuthTokenType_BASE_ACCESS_TOKEN AuthTokenType = 1 // open platform baseAccessToken.
)
...
const (
	SpecSourceType_UNSPECIFIED SpecSourceType = 0 // use the value of x-source about header.
	SpecSourceType_WEB         SpecSourceType = 1 // specify x-source as "web".
)
...
const (
	...
	LoadBalancer_CONSISTENT  LoadBalancer = 1 // Consistent hashing.
)
...
const (
	...
	OperatorType_GT                    OperatorType = 1 // Greater than
	OperatorType_LT                    OperatorType = 2 // Less than
	OperatorType_EQ                    OperatorType = 3 // Equals
	OperatorType_MATCH                 OperatorType = 4 // String pattern match.
	OperatorType_NON_NIL               OperatorType = 5 // Not nil
	OperatorType_LEN_GT                OperatorType = 6 // String length great than
	OperatorType_LEN_LT                OperatorType = 7 // String length less than
	OperatorType_LEN_EQ                OperatorType = 8 // String length equals
)
...
const (
	...
	FunctionType_TRIM                  FunctionType = 1 // String trim.
)
...
const (
	...
	ValueType_NUMBER             ValueType = 1 // Represent all number type like int,real
	ValueType_STRING             ValueType = 2 // String
...
var file_httpoptions_annotations_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x75, 0x6c, 0x65, 0x73, 0x52, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x42, 0x29, 0x0a, 0x0c, 0x63,
	0x6f, 0x6d, 0x2e, 0x65, 0x61, 0x73, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x10, 0x41, 0x6e, 0x6e,
	0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0xa2,
...
var file_httpoptions_annotations_proto_goTypes = []interface{}{
	...
	(*descriptor.MethodOptions)(nil),  // 12: google.protobuf.MethodOptions
