...
type GatewayServiceHook interface {
	...
	RequestParsed(ctx context.Context, svc *Service, m *Method, reqProto proto.Message, meta *runtime.ServerMetadata) error
	...
	RequestHandled(ctx context.Context, svc *Service, m *Method, responseProto proto.Message, meta *runtime.ServerMetadata, err error)
}
...
// GatewayServiceHook.
func RequestParsed(ctx context.Context, spec *pb.ServiceSpec, name string, methodName string, reqProto proto.Message, meta *runtime.ServerMetadata) error {
	if hook == nil {
		return nil
	}
...
func RequestHandled(ctx context.Context, spec *pb.ServiceSpec, name string, methodName string, out proto.Message, meta *runtime.ServerMetadata, err error) {
	if hook != nil {
		sg := GetServiceGroup(spec)
		s := sg.Services[name]
